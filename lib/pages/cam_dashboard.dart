...
class _CamDashboardState extends State<CamDashboard>
  ...
  void initState() {
    ...
    _motionCtrl = AnimationController(vsync: this, duration: const Duration(milliseconds: 900))..repeat(reverse: true);
  ...
  @override
  void dispose() {
    _timer?.cancel(); _countdown?.cancel();
    _pulseCtrl.dispose(); _fadeCtrl.dispose(); _motionCtrl.dispose();
    super.dispose();
  }

  void _startPeriodicMode() {
    _timer?.cancel(); _countdown?.cancel();
    _timer = Timer.periodic(_periodicInterval, (_) => _executeAcquisition(withPhoto: false));
    _startCountdown();
  ...
  Future<void> _demandePhoto() async {
    ...
    try {
      ...
      await _executeAcquisition(withPhoto: true);
    } catch (_) {} finally {
  ...
  Future<void> _executeAcquisition({required bool withPhoto}) async {
    ...
    try {
      ...
      final data = await UbidotsService.applyAlertsAndSendCam(raw: raw, alarmeOverrideOff: _alarmeOverrideOff);
  ...
  Widget build(BuildContext context) {
    return FadeTransition(
      ...
      child: RefreshIndicator(
        ...
        color: _amber, backgroundColor: _surface,
      ...
      title: Row(children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: _amber.withOpacity(0.12), borderRadius: BorderRadius.circular(11),
          ),
        ...
        if (_isLoading) ...[
          ...
          SizedBox(width: 12, height: 12,
              child: CircularProgressIndicator(strokeWidth: 2, color: _amber.withOpacity(0.6))),
        ],
      ]),
      actions: [
        _buildAlertBtn(),
        Container(
          ...
          child: IconButton(
            ...
            onPressed: _isLoading ? null : () => _executeAcquisition(withPhoto: false),
          ),
        ),
      ],
      ...
      child: Stack(clipBehavior: Clip.none, children: [
        ...
        if (_alertCount > 0) Positioned(
          ...
          child: Container(
            ...
            child: Center(child: Text(_alertCount > 9 ? '9+' : '$_alertCount',
    ...
    return Row(children: [
      AnimatedBuilder(
        ...
        builder: (_, __) => Container(
          width: 7, height: 7,
          decoration: BoxDecoration(
            color: _connected ? _green : _text3, shape: BoxShape.circle,
            boxShadow: _connected ? [BoxShadow(
              color: _green.withOpacity(0.4 * _pulseAnim.value), blurRadius: 6, spreadRadius: 1,
            )] : null,
          ),
        ),
      ),
            ...
            builder: (_, __) {
              ...
              return Transform.scale(
                ...
                child: Container(
                  width: 56, height: 56,
                  decoration: BoxDecoration(
                    color: detected ? _red.withOpacity(0.15) : _green.withOpacity(0.12),
                  ...
                  AnimatedBuilder(
                    ...
                    builder: (_, __) => Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [BoxShadow(
                          color: _red.withOpacity(0.6 * _pulseAnim.value), blurRadius: 4,
                        )],
                      ),
                    ),
                  ),
        ...
        child: Column(children: [
          ...
          ClipRRect(
            ...
            child: _data.lastPhotoUrl != null
                ? Image.network(_data.lastPhotoUrl!, height: 160, width: double.infinity,
                    fit: BoxFit.cover,
          ...
          Padding(
            ...
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: _loadingPhoto ? _amber.withOpacity(0.15) : _amber.withOpacity(0.10),
                  borderRadius: BorderRadius.circular(14),
                  border: Border.all(color: _amber.withOpacity(_loadingPhoto ? 0.40 : 0.25)),
                ),
                child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text(
                    ...
                    style: const TextStyle(color: _amber, fontSize: 13, fontWeight: FontWeight.w700),
                  ),
                ]),
              ),
            ),
        ...
        child: Column(children: [
          ...
          Row(children: [
            Container(
              width: 40, height: 40,
              decoration: BoxDecoration(
                color: _red.withOpacity(0.15), borderRadius: BorderRadius.circular(12),
              ),
  ...
  Widget _buildAutoRefreshCard() {
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        GestureDetector(
          onTap: _isLoading ? null : () => _executeAcquisition(withPhoto: false),
          child: Container(
